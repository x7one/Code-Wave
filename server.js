    ...
    try {
      ...
      <body>
          <div class="container">
            ...
            <p>От лица всей команды CodeWare мы хотим выразить вам искреннюю благодарность за оказанное доверие и выбор нашей компании в качестве партнера для реализации вашего проекта. Мы рады, что наше предложение о сотрудничестве заинтересовало вас и мы получили возможность работать вместе.
